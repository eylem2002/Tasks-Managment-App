...
import com.example.rosie.activities.introApp.SignIn;
...
//        navEmail.setText(email);
    ...
    public void setHeaderInfo() {
        String name= SharedPrefManager.getInstance(navPage.this).getUsers().getName();
        String email=SharedPrefManager.getInstance(navPage.this).getUsers().getEmail();
        String phone=SharedPrefManager.getInstance(navPage.this).getUsers().getPhone();
        navUsername.setText(name);
        navEmail.setText(email);
        navPhone.setText(phone);
